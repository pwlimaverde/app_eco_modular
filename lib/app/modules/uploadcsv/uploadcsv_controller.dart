...
//              setStatus(UploadcsvStatus.loading);
              ...
              for (String item in decoderRow) {
                ...
                up.entrega = entregaFD;
                print("---------");
                print("orcamento - ${up.orcamento}");
                print("cliente - ${up.cliente}");
                print("servico - ${up.servico}");
                print("quant - ${up.quant}");
                print("valor - ${up.valor}");
                print("entrada - ${up.entrada}");
                print("vendedor - ${up.vendedor}");
                print("op - ${up.op}");
                print("entrega - ${up.entrega}");
                print("produzido - ${up.produzido}");
                print("entregue - ${up.entregue}");
                print("cancelada - ${up.cancelada}");
                print("obs - ${up.obs}");
                print("---------");
                listOps.add(up);
              }
